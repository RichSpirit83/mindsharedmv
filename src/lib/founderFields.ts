...
export const FIELD_ALIASES: Record<string, string[]> = {
  ...
  sector: ["describe what sector", "sector", "industry"],
  primary_market: ["what is the primary market", "primary market served", "primarymarketserved", "primarymarket", "primary market"],
  business_type: ["which of the following best describes your business", "business type", "businesstype"],
  customer_type: ["customer type", "customertype", "general go to market profile"],
  icp: ["briefly describe your ideal customer profile", "ideal customer profile", "icp"],
  employee_count: ["company size # of employees", "company size employees", "# employees", "employees", "employeecount", "employee count", "numemployees"],
  revenue: ["company size revenue", "indicate the arr", "annual recurring revenue", "revenue", "revenueband", "revenue band"],
  capital_raised: ["company size capitalization", "amount of investment received", "capital raised", "capitalraised"],
  last_round: ["last round raised", "lastroundraised", "lastround", "last round"],
  has_pmf: ["have you found product market fit", "product / market fit?", "productmarketfit", "has pmf", "product market fit", "pmf"],
  sales_stage: ["where are you in your sales evolution", "sales evolution", "sales stage", "salesstage"],
